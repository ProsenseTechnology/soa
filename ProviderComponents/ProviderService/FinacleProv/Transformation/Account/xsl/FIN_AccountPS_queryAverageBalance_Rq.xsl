...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [TUE MAY 26 17:53:19 IST 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <app:QueryAverageBalanceInput>
      <app:cifId>
        <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account/custeo:Customer/com:CustomerIdentifier/com:CustomerID"/>
      </app:cifId>
      <app:eodDate>
        <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account/eo:Period"/>
      </app:eodDate>
    </app:QueryAverageBalanceInput>
  </xsl:template>
</xsl:stylesheet>
