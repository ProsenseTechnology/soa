        ...
        <app:executeFinacleScriptRequest>
          ...
          <app:executeFinacleScript_CustomData>
            <app:CustAcctInquiry_REQ>
              <xsl:if test="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/eo:UserID">
                <app:UserID>
                  <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/eo:UserID"/>
                </app:UserID>
              </xsl:if>
              <xsl:if test="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/com:AccountIdentifier/com:BankID">
                <app:BankID>
                  <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/com:AccountIdentifier/com:BankID"/>
                </app:BankID>
              </xsl:if>
              <xsl:if test="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/com:AccountIdentifier/com:AccountID">
                <app:AccountID>
                  <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/com:AccountIdentifier/com:AccountID"/>
                </app:AccountID>
              </xsl:if>
              <xsl:if test="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/custeo:Customer/com:CustomerIdentifier/com:CustomerID">
                <app:CustomerID>
                  <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/custeo:Customer/com:CustomerIdentifier/com:CustomerID"/>
                </app:CustomerID>
              </xsl:if>
              <xsl:if test="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/custeo:Customer/com:Person/com:IdentityDocument/com:IdentityDocumentID">
                <app:NationalID>
                  <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Account[number($index)]/custeo:Customer/com:Person/com:IdentityDocument/com:IdentityDocumentID"/>
                </app:NationalID>
              </xsl:if>
            </app:CustAcctInquiry_REQ>
          </app:executeFinacleScript_CustomData>
