      ...
      <app:Header>
        <app:RequestHeader>
          ...
          <app:RequestMessageInfo>
            <app:BankId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:CurrencyExchange/com:BankID"/>
            </app:BankId>
            <app:TimeZone/>
            <app:EntityId/>
            <app:EntityType/>
      ...
      <app:Body>
        <app:executeFinacleScriptRequest>
          <app:ExecuteFinacleScriptInputVO>
            <app:requestId>dealrate.scr</app:requestId>
          </app:ExecuteFinacleScriptInputVO>
          <app:executeFinacleScript_CustomData>
            <app:cifId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:CurrencyExchange/com:CustomerID"/>
            </app:cifId>
            <app:DealRefNo>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:CurrencyExchange/com:CurrencyExchangeIdentifier/com:CurrencyExchangeID"/>
            </app:DealRefNo>
          </app:executeFinacleScript_CustomData>
        </app:executeFinacleScriptRequest>
      </app:Body>
