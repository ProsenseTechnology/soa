...
<xsl:stylesheet version="1.0" xmlns:eo="http://xmlns.equitybank.co.ke/ESB/EO/Transactions/Transfer/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryRTGSOutwardRefStatusOutputCollection"
  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      <eo:RsData>
        <xsl:for-each select="/app:QueryRTGSOutwardRefStatusOutputCollection/app:QueryRTGSOutwardRefStatusOutput">
          <eo:Transfer>
        ...
        <xsl:if test="count (/app:QueryRTGSOutwardRefStatusOutputCollection/app:QueryRTGSOutwardRefStatusOutput ) > 0">
          <com:Status>
            <com:Code>ESB-00</com:Code>
            <com:Type>Success</com:Type>
            <com:Text>RTGS outward ref status queried successfully</com:Text>
          </com:Status>
        </xsl:if>
        <xsl:if test="count (/app:QueryRTGSOutwardRefStatusOutputCollection/app:QueryRTGSOutwardRefStatusOutput ) &lt;= 0">
          <com:Status>
            ...
            <com:Text>RTGS outward ref status details not found</com:Text>
          </com:Status>
        </xsl:if>
      </eo:RsData>
    </eo:ESBMsg>
