  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryNEFTOutwardRefStatusOutputCollection"
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SUN MAY 10 10:52:48 IST 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <eo:ESBMsg>
      <eo:RsData>
        <xsl:for-each select="/app:QueryNEFTOutwardRefStatusOutputCollection/app:QueryNEFTOutwardRefStatusOutput">
          <eo:Transfer>
        ...
        <xsl:if test="count (/app:QueryNEFTOutwardRefStatusOutputCollection/app:QueryNEFTOutwardRefStatusOutput ) > 0">
          <com:Status>
            <com:Code>ESB-00</com:Code>
            <com:Type>Success</com:Type>
            <com:Text>NEFT outward ref status queried successfully</com:Text>
          </com:Status>
        </xsl:if>
        <xsl:if test="count (/app:QueryNEFTOutwardRefStatusOutputCollection/app:QueryNEFTOutwardRefStatusOutput ) &lt;= 0">
          <com:Status>
            ...
            <com:Text>NEFT outward ref status details not found</com:Text>
          </com:Status>
        </xsl:if>
      </eo:RsData>
    </eo:ESBMsg>
