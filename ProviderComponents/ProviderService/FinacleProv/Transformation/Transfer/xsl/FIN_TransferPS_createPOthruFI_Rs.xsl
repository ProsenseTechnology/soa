      ...
      <eo:RsData>
        <eo:Transfer>
          <com:TransferIdentifier>
            ...
            <com:TransferID>
            <xsl:value-of select="/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:SWIFTLISTStruct/app:PymtRefNum"/>
            </com:TransferID>
          </com:TransferIdentifier>
        ...
        <xsl:choose>
          <xsl:when test="count(/app:FIXML/app:Body/app:Error) &lt;= 0 and count(/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:ERROR) &lt;= 0 and count(/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:Error) &lt;= 0">
            <com:Status>
              <com:Code>ESB-00</com:Code>
              <com:Type>
                <xsl:value-of select="/app:FIXML/app:Header/app:ResponseHeader/app:HostTransaction/app:Status"/>
              </com:Type>
              <com:Text>Payment processed successfully</com:Text>
            </com:Status>
          </xsl:when>
          <xsl:otherwise>
            <com:Status>
              ...
              <xsl:choose>
                ...
                <xsl:when test="count (/app:FIXML/app:Body/app:Error/app:FISystemException ) > 0">
                  <com:Text>
                ...
                <xsl:when test="count (/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:Error) > 0">
                  <com:Text>
                    <xsl:value-of select="/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:Error"/>
                  </com:Text>
                </xsl:when>
                <xsl:otherwise>
                  <com:Text>
