...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
                ...
                exclude-result-prefixes="xsi oracle-xsl-mapper xsl xsd ns0 app oraxsl DVMFunctions BasicCredentialsUserFunction UUIDUserFunction IsUserInRoleFunction IsUserInGroupFunction XrefFunctions"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryClientEmailInput"
                                       namespace="http://xmlns.equitybank.co.ke/ESB/PS/Finacle/Adapter/db"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [MON JUL 27 12:29:11 IST 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <app:QueryClientEmailInput>
      <xsl:if test="/eo:ESBMsg/eo:RqData/eo:Customer/acceo:Account/com:TransactionReferenceNumber">
        <app:payRefNum>
          <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Customer/acceo:Account/com:TransactionReferenceNumber"/>
        </app:payRefNum>
      </xsl:if>
    </app:QueryClientEmailInput>
  </xsl:template>
