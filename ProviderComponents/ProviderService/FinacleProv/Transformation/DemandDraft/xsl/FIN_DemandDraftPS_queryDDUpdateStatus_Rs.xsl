...
<xsl:stylesheet version="1.0" xmlns:app="http://xmlns.equitybank.co.ke/ESB/PS/Finacle/Adapter/db"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryDDUpdateStatusOutputCollection"
  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      <eo:RsData>
        <xsl:for-each select="/app:QueryDDUpdateStatusOutputCollection/app:QueryDDUpdateStatusOutput">
          <eo:DemandDraft>
            <com:DemandDraftIdentifier>
              <com:BankID>
            ...
            <eo:DemandDraftStatus>
              <xsl:value-of select="app:Status"/>
            </eo:DemandDraftStatus>
          </eo:DemandDraft>
        </xsl:for-each>
        <xsl:if test="count (/app:QueryDDUpdateStatusOutputCollection/app:QueryDDUpdateStatusOutput ) > 0">
          <com:Status>
            <com:Code>ESB-00</com:Code>
            <com:Type>Success</com:Type>
            <com:Text>Demand draft queried successfully</com:Text>
          </com:Status>
        </xsl:if>
        <xsl:if test="count (/app:QueryDDUpdateStatusOutputCollection/app:QueryDDUpdateStatusOutput ) &lt;= 0">
          <com:Status>
            ...
            <com:Text>Demand draft details not found</com:Text>
          </com:Status>
        </xsl:if>
      </eo:RsData>
    </eo:ESBMsg>
