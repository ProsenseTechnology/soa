      ...
      <eo:RsData>
        <eo:ChequeBook>
          <eo:BeginChequeNumber>
            <xsl:value-of select="/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:StartChqNo"/>
          </eo:BeginChequeNumber>
          <eo:EndChequeNumber>
            <xsl:value-of select="/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:endChqNo"/>
          </eo:EndChequeNumber>
        </eo:ChequeBook>
        <xsl:choose>
          ...
          <xsl:when test="/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:SuccessOrFailure='N'">
            <com:Status>
              ...
              <com:Text>
                <xsl:value-of select="/app:FIXML/app:Body/app:executeFinacleScriptResponse/app:executeFinacleScript_CustomData/app:Error_2"/>
              </com:Text>
            </com:Status>
          </xsl:when>
          <xsl:otherwise>
            <com:Status>
              <com:Code>ESB-100</com:Code>
              <com:Type>FAILURE</com:Type>
              <com:Text>INVALID ENTRY</com:Text>
            </com:Status>
          </xsl:otherwise>
        </xsl:choose>
      </eo:RsData>
