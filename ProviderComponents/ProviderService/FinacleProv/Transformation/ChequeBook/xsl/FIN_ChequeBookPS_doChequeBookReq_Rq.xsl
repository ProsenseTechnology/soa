...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <xsl:template match="/">
    <app:FIXML schemalocation="http://www.finacle.com/fixml">
      <app:Header>
        <app:RequestHeader>
          <app:MessageKey>
            ...
            <app:ServiceRequestId>doChequeBookReq</app:ServiceRequestId>
          ...
          <app:RequestMessageInfo>
            <app:BankId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:ChequeBook/com:ChequeBookIdentifier/com:BankID"/>
            </app:BankId>
      ...
      <app:Body>
        <app:doChequeBookReqRequest>
          <app:ChequeBookInputVO>
            <app:acid>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:ChequeBook/com:ChequeBookIdentifier/com:AccountID"/>
            </app:acid>
            <app:branchId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:ChequeBook/com:ChequeBookIdentifier/com:BranchID"/>
            </app:branchId>
            <app:numberOfLeaves>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:ChequeBook/com:NoOfLeaves"/>
            </app:numberOfLeaves>
          </app:ChequeBookInputVO>
        </app:doChequeBookReqRequest>
        <app:Body/>
