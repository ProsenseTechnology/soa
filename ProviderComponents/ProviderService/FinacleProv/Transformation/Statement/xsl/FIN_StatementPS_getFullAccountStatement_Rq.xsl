...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <xsl:template match="/">
    <app:FIXML schemalocation="http://www.finacle.com/fixml">
      <app:Header>
        <app:RequestHeader>
          <app:MessageKey>
            ...
            <app:ServiceRequestId>getFullAccountStatement</app:ServiceRequestId>
          ...
          <app:RequestMessageInfo>
            <app:BankId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Statement/com:AccountIdentifier/com:BankID"/>
            </app:BankId>
            <app:TimeZone/>
            <app:EntityId/>
            <app:EntityType/>
      ...
      <app:Body>
        <app:getFullAccountStatementRequest>
          <app:AccountTransactionCriteria>
            <app:acid>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Statement/com:AccountIdentifier/com:AccountID"/>
            </app:acid>
            <app:branchId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Statement/com:AccountIdentifier/com:BranchID"/>
            </app:branchId>
            <app:fromDate>
              <xsl:value-of select="xp20:format-dateTime(/eo:ESBMsg/eo:RqData/eo:Statement/eo:FromDate,'[Y0001]-[M01]-[D01]T[H01]:[M01]:[s01].[s001]')"/>
            </app:fromDate>
          </app:AccountTransactionCriteria>
        </app:getFullAccountStatementRequest>
      </app:Body>
