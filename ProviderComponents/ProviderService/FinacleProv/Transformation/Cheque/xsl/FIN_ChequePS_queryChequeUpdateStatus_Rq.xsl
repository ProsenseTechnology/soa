...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryChequeUpdateStatusInput"
  ...
  <xsl:template match="/">
    <app:QueryChequeUpdateStatusInput>
      <app:startDate>
        <xsl:value-of select="xp20:format-dateTime(/eo:ESBMsg/eo:RqData/eo:Cheque/eo:IssueDate,'[D01]-[MNn,3-3]-[Y0001]')"/>
      </app:startDate>
      <app:endDate>
        <xsl:value-of select="xp20:format-dateTime(/eo:ESBMsg/eo:RqData/eo:Cheque/com:EndDate,'[D01]-[MNn,3-3]-[Y0001]')"/>
      </app:endDate>
    </app:QueryChequeUpdateStatusInput>
  </xsl:template>
</xsl:stylesheet>
