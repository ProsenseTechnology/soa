...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <xsl:template match="/">
    <app:FIXML schemalocation="http://www.finacle.com/fixml">
      <app:Header>
        <app:RequestHeader>
          <app:MessageKey>
            ...
            <app:ServiceRequestId>getChequesForChequebook</app:ServiceRequestId>
      ...
      <app:Body>
        <app:getChequesForChequebookRequest>
          <app:ChequeInquiryCriteria>
            <app:acid>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Cheque/com:ChequeIdentifier/com:AccountID"/>
            </app:acid>
            <app:beginChequeNumber>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Cheque/eo:BeginChequeNumber"/>
            </app:beginChequeNumber>
            <app:branchId>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Cheque/com:ChequeIdentifier/com:BranchID"/>
            </app:branchId>
            <app:endChequeNumber>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Cheque/eo:EndChequeNumber"/>
            </app:endChequeNumber>
          </app:ChequeInquiryCriteria>
        </app:getChequesForChequebookRequest>
      </app:Body>
