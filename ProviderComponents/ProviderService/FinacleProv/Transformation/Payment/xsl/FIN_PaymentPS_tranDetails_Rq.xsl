      ...
      <app:Body>
        <app:executeFinacleScriptRequest>
          <app:ExecuteFinacleScriptInputVO>
            <app:requestId>TranDetails</app:requestId>
          </app:ExecuteFinacleScriptInputVO>
          <app:executeFinacleScript_CustomData>
            <app:tranID>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Payment/com:PaymentIdentifier/com:PaymentID"/>
            </app:tranID>
            <app:tranDate>
              <xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Payment/com:ValueDate"/>
            </app:tranDate>
          </app:executeFinacleScript_CustomData>
        </app:executeFinacleScriptRequest>
      </app:Body>
