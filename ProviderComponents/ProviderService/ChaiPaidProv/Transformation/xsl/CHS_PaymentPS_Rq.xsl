<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU MAY 21 11:53:53 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <Request>
      <xsl:for-each select="/ns0:ESBMsg/ns0:RqData/ns0:Bill/com:BillRef">
        <refs>
          <xsl:value-of select="."/>
        </refs>
      </xsl:for-each>
