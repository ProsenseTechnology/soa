  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryCreditCardFeedInput"
                                       namespace="http://xmlns.equitybank.co.ke/ESB/PS/Way4/Adapter/db"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU MAY 14 10:59:51 IST 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="index"/>
  <xsl:template match="/">
    <app:QueryCreditCardFeedInput>
      <app:startDate>
        <xsl:value-of select="xp20:format-dateTime(/eo:ESBMsg/eo:RqData/eo:Card[number($index)]/eo:CardOpenDate,'[D01]-[MNn,3-3]-[Y0001]')"/>
      </app:startDate>
      <app:startDate1>
        <xsl:value-of select="xp20:format-dateTime(/eo:ESBMsg/eo:RqData/eo:Card[number($index)]/eo:CardOpenDate,'[D01]-[MNn,3-3]-[Y0001]')"/>
      </app:startDate1>
