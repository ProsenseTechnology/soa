...
<xsl:stylesheet version="1.0" xmlns:eo="http://xmlns.equitybank.co.ke/ESB/EO/Resilience/Access/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [FRI MAY 29 10:39:38 EAT 2015].-->
  </oracle-xsl-mapper:schema>
      ...
      <eo:RsData>
        ...
        <xsl:choose>
          <xsl:when test="/MidletRs/Set/String[@Name='RC'] = 'OK'">
            <com:Status>
              <com:Code>
                <xsl:value-of select="string('ESB-00')"/>
              </com:Code>
            ...
            <com:Status>
              <xsl:choose>
                <xsl:when test="/MidletRs/Set/String[@Name='TEXT'] = 'Wrong PIN'">
                  <com:Code>
                    <xsl:value-of select="string('ESB-100')"/>
                  </com:Code>
                </xsl:when>
                <xsl:otherwise>
                  <com:Code>
                    <xsl:value-of select="string('ESB-101')"/>
                  </com:Code>
                </xsl:otherwise>
              </xsl:choose>
