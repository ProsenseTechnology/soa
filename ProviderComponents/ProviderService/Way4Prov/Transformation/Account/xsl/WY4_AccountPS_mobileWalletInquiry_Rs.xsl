...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="MidletRs" namespace=""/>
  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      <eo:RsData>
        <eo:Account>
		<xsl:if test="/MidletRs/Set/String[1] = 'OK'">
          <com:AccountIdentifier>
		  <com:AccountID>
              <xsl:value-of select="/MidletRs/Set/String[2]"/>
            </com:AccountID>
          </com:AccountIdentifier>
		  </xsl:if>
          <custeo:Customer>
            <com:Person>
              <com:PersonName>
			  <xsl:choose>
			  <xsl:when test="/MidletRs/Set/String[1] = 'OK'">
                <com:FullName>
                  <xsl:value-of select="/MidletRs/Set/String[3]"/>
                </com:FullName>
				</xsl:when>
			  <xsl:otherwise>
			   <com:FullName>
        ...
        <com:Status>
          <xsl:choose>
            <xsl:when test="/MidletRs/Set/String[1] = 'OK'">
              ...
              <com:Text>Mobile wallet inquiry processed successfully</com:Text>
            </xsl:when>
            <xsl:when test="/MidletRs/Set/String[2] = '101'">
            ...
            <xsl:when test="/MidletRs/Set/String[2] = '104'">
              <com:Code>ESB-100</com:Code>
              <com:Type>Failure</com:Type>
              <com:Text>
                <xsl:value-of select="/MidletRs/Set/String[3]"/>
