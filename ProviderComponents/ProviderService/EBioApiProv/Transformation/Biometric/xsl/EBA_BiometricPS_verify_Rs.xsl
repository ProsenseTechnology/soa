...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      <eo:RsData>
        <eo:Biometric>
          <xsl:if test="/app:message/app:verify/app:candidates/app:applicant/app:afis_id/text()!=''">
            <com:BiometricIdentifier>
              <com:BiometricID>
                <xsl:value-of select="/app:message/app:verify/app:candidates/app:applicant/app:afis_id"/>
              </com:BiometricID>
            </com:BiometricIdentifier>
          </xsl:if>
        </eo:Biometric>
        <xsl:choose>
          <xsl:when test="count(/app:message/app:verify/app:candidates/app:candidate)>0">
            <com:Status>
              <com:Code>ESB-00</com:Code>
              <com:Type>Success</com:Type>
              <com:Text>Biometric verified successfully</com:Text>
            </com:Status>
          </xsl:when>
          <xsl:otherwise>
            <com:Status>
              ...
              <com:Text>
                <xsl:value-of select="concat('Biometric verification failed. Error: ',/app:message/app:failure/app:error/text(),'  RejectedMessage: ',/app:message/app:failure/app:rejected_message/text())"/>
              </com:Text>
            </com:Status>
          </xsl:otherwise>
        </xsl:choose>
