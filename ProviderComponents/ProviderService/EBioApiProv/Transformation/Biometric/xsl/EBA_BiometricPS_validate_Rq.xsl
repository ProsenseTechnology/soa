    ...
    <app:message>
      ...
      <app:identify>
        <app:applicant>
          <app:biometric_data>
            <app:fingerprints>
              <xsl:for-each select="/eo:ESBMsg/eo:RqData/eo:Biometric/eo:BiometricImage/com:FingerPrints/*">
                <xsl:if test="./text()!=''">
                  <app:fingerprint>
                    <app:position>UnknownFinger</app:position>
                    <app:image>
              ...
              <!--app:fingerprint>
                ...
                <app:image>
                  <app:resolution_dpi>500</app:resolution_dpi>
                  <app:format><xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Biometric/eo:BiometricImage/com:FingerPrints/com:ImageR5/@mimeCode"/></app:format>
                  <app:data>
              ...
              <app:fingerprint>
                ...
                <app:image>
                  <app:resolution_dpi>500</app:resolution_dpi>
                  <app:format><xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Biometric/eo:BiometricImage/com:FingerPrints/com:ImageR4/@mimeCode"/></app:format>
                  <app:data>
              ...
              <app:fingerprint>
                ...
                <app:image>
                  <app:resolution_dpi>500</app:resolution_dpi>
                  <app:format><xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Biometric/eo:BiometricImage/com:FingerPrints/com:ImageL5/@mimeCode"/></app:format>
                  <app:data>
              ...
              <app:fingerprint>
                ...
                <app:image>
                  <app:resolution_dpi>500</app:resolution_dpi>
                  <app:format><xsl:value-of select="/eo:ESBMsg/eo:RqData/eo:Biometric/eo:BiometricImage/com:FingerPrints/com:ImageL4/@mimeCode"/></app:format>
                  <app:data>
        ...
        <app:parameters>
          <app:candidates_count>1</app:candidates_count>
          <app:similarity_threshold>750</app:similarity_threshold>
          <app:identification_speed>9</app:identification_speed>
          <app:max_rotation>180</app:max_rotation>
          <app:min_matching_fingerprints>0</app:min_matching_fingerprints>
        </app:parameters>
      </app:identify>
    </app:message>
  </xsl:template>
