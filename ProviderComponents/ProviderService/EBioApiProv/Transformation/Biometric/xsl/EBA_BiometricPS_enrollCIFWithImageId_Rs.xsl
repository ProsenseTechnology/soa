        ...
        <xsl:choose>
          <xsl:when test="/response/responseCode/text()='00'">
            <com:Status>
              ...
              <com:Text>Biometric CIF enrolled for image successfully:  <xsl:value-of select="/response/responseMessage"/></com:Text>
            </com:Status>
          </xsl:when>
          <xsl:otherwise>
            <com:Status>
              ...
              <com:Text>
                <xsl:value-of select="concat('Biometric CIF enrollment for image failed. Error: ',/response/responseMessage/text())"/>
              </com:Text>
            </com:Status>
          </xsl:otherwise>
        </xsl:choose>
