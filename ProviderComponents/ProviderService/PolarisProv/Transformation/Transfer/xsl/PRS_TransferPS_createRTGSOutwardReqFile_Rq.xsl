...
<xsl:stylesheet version="1.0" xmlns:ns0="http://xmlns.equitybank.co.ke/ESB/EO/Transactions/Transfer/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [WED JUL 22 20:45:32 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:param name="filename"/>
  <xsl:template match="/">
    <tns:RTGSOutwardRespFileInput>
      <tns:HeaderLine>
      ...
      <xsl:for-each select="/ns0:ESBMsg/ns0:RqData/ns0:Transfer">
        <tns:DataLine>
          <tns:LineIdentifier>D</tns:LineIdentifier>
          <tns:TransactionRefNo>
            <xsl:value-of select="com:TransactionReferenceNumber"/>
          </tns:TransactionRefNo>
          <tns:Status>
            <xsl:value-of select="ns0:TransferStatus"/>
          </tns:Status>
        </tns:DataLine>
      </xsl:for-each>
      <tns:TrailerLine>
        ...
        <tns:NumberOfRows>
          <xsl:value-of select="count (/ns0:ESBMsg/ns0:RqData/ns0:Transfer )"/>
        </tns:NumberOfRows>
      </tns:TrailerLine>
    </tns:RTGSOutwardRespFileInput>
  </xsl:template>
