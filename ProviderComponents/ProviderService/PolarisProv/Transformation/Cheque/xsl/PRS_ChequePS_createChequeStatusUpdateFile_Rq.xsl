...
<xsl:stylesheet version="1.0" xmlns:eo="http://xmlns.equitybank.co.ke/ESB/EO/Instruments/Cheque/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="ChequeStatusUpdateFileInput"
  ...
  <xsl:template match="/">
    <app:ChequeStatusUpdateFileInput>
      <app:HeaderLine>
      ...
      <xsl:for-each select="/eo:ESBMsg/eo:RqData/eo:Cheque">
        <app:DataLine>
          ...
          <app:Status>
            <xsl:value-of select="eo:ChequeStatus"/>
          </app:Status>
        </app:DataLine>
      </xsl:for-each>
      <app:TrailerLine>
        ...
        <app:NumberOfRows>
          <xsl:value-of select="count (/eo:ESBMsg/eo:RqData/eo:Cheque )"/>
        </app:NumberOfRows>
      </app:TrailerLine>
    </app:ChequeStatusUpdateFileInput>
  </xsl:template>
