  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="documentListVO" namespace=""/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SUN MAY 17 22:43:43 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:ESBMsg>
      <tns:RsData>
        <xsl:for-each select="/documentListVO/documentVO">
          <tns:Document>
            ...
            <tns:DocumentTypeID>
              <xsl:value-of select="entityIdType"/>
            </tns:DocumentTypeID>
            <tns:DocumentSubTypeID>
              <xsl:value-of select="entityIdNumber"/>
            </tns:DocumentSubTypeID>
            <tns:DocumentCreatedBy>
              <xsl:value-of select="username"/>
            </tns:DocumentCreatedBy>
            <tns:DocumentUpdatedBy/>
            <tns:DocumentFileContent mimeCode="{contentType}" fileName="{filename}">
