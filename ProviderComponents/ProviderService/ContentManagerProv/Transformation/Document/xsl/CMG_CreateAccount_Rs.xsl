  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="statusVO" namespace=""/>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SAT MAY 09 07:52:46 IST 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:ESBMsg>
      <tns:RsData>
        <com:Status>
          <com:Code>
            <xsl:value-of select="/statusVO/status"/>
          </com:Code>
        </com:Status>
      </tns:RsData>
    </tns:ESBMsg>
