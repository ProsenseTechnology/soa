  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      ...
      <xsl:if test="/rs:ESBMsg/rs:RqData">
        <custeo:RqData actionCode="QueryRetailCustomerStatusByID">
              ...
              <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Customer/com:CustomerIdentifier">
                <com:CustomerIdentifier>
                  ...
                  <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Customer/com:CustomerIdentifier/com:CustomerID">
                    <com:CustomerID>
                      <xsl:value-of select="concat('54',/rs:ESBMsg/rs:RqData/rs:Customer/com:CustomerIdentifier/com:CustomerID)"/>
                    </com:CustomerID>
                  </xsl:if>
                </com:CustomerIdentifier>
              </xsl:if>
