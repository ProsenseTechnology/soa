...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU JUN 11 09:48:51 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      ...
      <com:Service>CustomeRS</com:Service>
      <xsl:if test="/rs:ESBMsg/rs:RqData">
        <eo:RqData actionCode="SendEmail">
          <eo:Notification>
            <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Notification/eo:FromEmailAddress">
              <eo:FromEmailAddress>
                <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Notification/eo:FromEmailAddress"/>
              </eo:FromEmailAddress>
            </xsl:if>
            <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Notification/eo:ToEmailAddress">
              <eo:ToEmailAddress>
                <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Notification/eo:ToEmailAddress"/>
              </eo:ToEmailAddress>
            </xsl:if>
            <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Notification/rs:Attachment">
              <eo:AttachmentPath>
                <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Notification/rs:Attachment"/>
              </eo:AttachmentPath>
            </xsl:if>
            <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Notification/eo:Subject">
              <eo:Subject>
                <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Notification/eo:Subject"/>
              </eo:Subject>
            </xsl:if>
