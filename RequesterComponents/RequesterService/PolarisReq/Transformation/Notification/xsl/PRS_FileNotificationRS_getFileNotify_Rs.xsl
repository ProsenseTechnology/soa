...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
                ...
                xmlns:tns="http://xmlns.equitybank.co.ke/ESB/RS/Polaris/FileNotification/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [FRI JUL 24 16:39:15 EAT 2015].-->
  </oracle-xsl-mapper:schema>
    ...
    <tns:ESBMsg>
      ...
      <tns:RsData>
        <com:Status>
          ...
          <com:Text>Request Received Succesfully</com:Text>
        </com:Status>
      </tns:RsData>
    </tns:ESBMsg>
  </xsl:template>
