  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      ...
      <xsl:if test="/rs:ESBMsg/rs:RqData">
        <eo:RqData actionCode="CreateChequeBook">
          <xsl:if test="/rs:ESBMsg/rs:RqData/rs:ChequeBook">
            <eo:ChequeBook>
              ...
              <xsl:if test="/rs:ESBMsg/rs:RqData/rs:ChequeBook/eo:NoOfChequeBook">
                <eo:NoOfChequeBook>
                  <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:ChequeBook/eo:NoOfChequeBook"/>
                </eo:NoOfChequeBook>
              </xsl:if>
