  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      ...
      <xsl:if test="/rs:ESBMsg/rs:RqData">
        <eo:RqData actionCode="StopChequePaymentByID">
          <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque">
            <eo:Cheque>
              ...
              <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque/rs:BeginChequeNumber">
                <eo:BeginChequeNumber>
                  <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Cheque/rs:BeginChequeNumber"/>
                </eo:BeginChequeNumber>
              </xsl:if>
              <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque/rs:EndChequeNumber">
                <eo:EndChequeNumber>
                  <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Cheque/rs:EndChequeNumber"/>
                </eo:EndChequeNumber>
              </xsl:if>
              <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction">
                <com:StopPaymentInstruction>
                  <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction/com:RequestDateTime">
                    <com:RequestDateTime>
                      <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction/com:RequestDateTime"/>
                    </com:RequestDateTime>
                  </xsl:if>
                  <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction/com:ReasonCode">
                    <com:ReasonCode>
                      <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction/com:ReasonCode"/>
                    </com:ReasonCode>
                  </xsl:if>
                  <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction/com:ReasonDescription">
                    <com:ReasonDescription>
                      <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Cheque/com:StopPaymentInstruction/com:ReasonDescription"/>
                    </com:ReasonDescription>
                  </xsl:if>
                </com:StopPaymentInstruction>
              </xsl:if>
