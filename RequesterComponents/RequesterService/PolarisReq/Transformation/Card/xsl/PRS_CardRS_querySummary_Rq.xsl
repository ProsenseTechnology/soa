  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      ...
      <xsl:if test="/rs:ESBMsg/rs:RqData">
        <eo:RqData actionCode="QueryCardSummaryByNumber">
          <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Card">
            <eo:Card>
              <xsl:if test="/rs:ESBMsg/rs:RqData/rs:Card/com:CardIdentifier">
                <xsl:for-each select="/rs:ESBMsg/rs:RqData/rs:Card/com:CardIdentifier">
                  <com:CardIdentifier>
                    <xsl:if test="com:BankID">
                      <com:BankID>
                        <xsl:value-of select="com:BankID"/>
                      </com:BankID>
                    </xsl:if>
                    <xsl:if test="com:CardNumber">
                      <com:CardNumber>
