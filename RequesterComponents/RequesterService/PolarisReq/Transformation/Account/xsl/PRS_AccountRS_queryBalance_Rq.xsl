...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <xsl:template match="/">
    <eo:ESBMsg>
      ...
      <xsl:choose>
        <xsl:when test="/rs:ESBMsg/rs:RqData/rs:Balance">
          <eo:RqData actionCode="QueryRetailAccountBalanceByID">
            <xsl:for-each select="/rs:ESBMsg/rs:RqData/rs:Balance/com:AccountIdentifier">
              <eo:Account>
        ...
        <xsl:otherwise>
          <eo:RqData>
            <eo:Account>
              <com:AccountIdentifier>
                <com:BankID>
                  <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Account/com:BankID"/>
                </com:BankID>
                <com:AccountID>
                  <xsl:value-of select="/rs:ESBMsg/rs:RqData/rs:Account/com:AccountID"/>
                </com:AccountID>
              </com:AccountIdentifier>
            </eo:Account>
          </eo:RqData>
