...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="GetAccountListRequestRM"
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [TUE MAY 19 12:29:50 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:ESBMsg>
      ...
      <tns:RqData actionCode="QueryAccountListByID">
        <tns:Document>
          <com:DocumentIdentifier>
            <com:DocumentID>
              <xsl:value-of select="/ns0:GetAccountListRequestRM/ns0:ID"/>
            </com:DocumentID>
          </com:DocumentIdentifier>
        </tns:Document>
      </tns:RqData>
