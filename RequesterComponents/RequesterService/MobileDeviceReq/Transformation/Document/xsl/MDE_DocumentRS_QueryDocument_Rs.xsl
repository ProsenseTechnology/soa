...
<xsl:stylesheet version="1.0" xmlns:oraxsl="http://www.oracle.com/XSL/Transform/java"
                ...
                xmlns:tns="http://xmlns.equitybank.co.ke/ESB/RO/ContentManager/Document/V1"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="QueryDocumentResponseRM"
                                       namespace="http://xmlns.equitybank.co.ke/ESB/RO/ContentManager/Document/V1"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [TUE MAY 19 12:26:26 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:QueryDocumentResponseRM>
      <xsl:for-each select="/ns0:ESBMsg/ns0:RsData/ns0:Document">
        <tns:Document>
          <tns:RefID>
            <xsl:value-of select="com:DocumentIdentifier/com:DocumentID"/>
          </tns:RefID>
          <tns:Content>
            <xsl:value-of select="ns0:DocumentFileContent"/>
          </tns:Content>
          <tns:Instruction>
            <xsl:value-of select="ns0:DocumentStatus"/>
          </tns:Instruction>
        </tns:Document>
      </xsl:for-each>
      <tns:Count>
