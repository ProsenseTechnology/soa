  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:source type="XSD">
        ...
        <oracle-xsl-mapper:rootElement name="CreateDocumentRequestRM"
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [SUN MAY 17 23:46:52 EAT 2015].-->
  </oracle-xsl-mapper:schema>
  ...
  <xsl:template match="/">
    <tns:ESBMsg>
      ...
      <tns:RqData actionCode="CreateDocument">
        <tns:Document>
          <tns:DocumentType>application/pdf</tns:DocumentType>
          <tns:DocumentName>onboardtransaction.json</tns:DocumentName>
          <tns:DocumentTypeID>REMOTE_MOBILE</tns:DocumentTypeID>
          <tns:DocumentSubTypeID>101</tns:DocumentSubTypeID>
          <tns:DocumentCreatedBy>remotemobile</tns:DocumentCreatedBy>
          <tns:DocumentUpdatedBy>mobiledevice</tns:DocumentUpdatedBy>
          <tns:DocumentFileContent mimeCode="application/pdf" fileName="onboardtransaction.json">
            <xsl:value-of select="/ns0:CreateDocumentRequestRM/ns0:Content"/>
          </tns:DocumentFileContent>
          <tns:DocumentStatus>0</tns:DocumentStatus>
        </tns:Document>
      </tns:RqData>
    </tns:ESBMsg>
  </xsl:template>
