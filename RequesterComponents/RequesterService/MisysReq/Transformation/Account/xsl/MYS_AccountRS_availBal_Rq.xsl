<xsl:stylesheet version="1.0"
  ...
  <oracle-xsl-mapper:schema>
    ...
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [MON MAY 11 13:03:40 IST 2015].-->
  </oracle-xsl-mapper:schema>
      ...
      <tns:RqData actionCode="QueryRetailAccountDetailByID">
        <tns:Account>
          <com:AccountIdentifier>
            ...
            <xsl:if test="/ns0:ServiceRequest/ns2:AvailBalRequest/ns2:BackOfficeAccount">
              <com:AccountID>
                <xsl:value-of select="/ns0:ServiceRequest/ns2:AvailBalRequest/ns2:BackOfficeAccount"/>
              </com:AccountID>
            </xsl:if>
            <xsl:if test="/ns0:ServiceRequest/ns2:AvailBalRequest/ns2:PostingCurrency">
              <com:AccountCurrency>
                <xsl:value-of select="/ns0:ServiceRequest/ns2:AvailBalRequest/ns2:PostingCurrency"/>
              </com:AccountCurrency>
            </xsl:if>
          </com:AccountIdentifier>
          <custeo:Customer>
            <com:CustomerIdentifier>
              <xsl:if test="/ns0:ServiceRequest/ns2:AvailBalRequest/ns2:Customer">
                <com:CustomerID>
                  <xsl:value-of select="/ns0:ServiceRequest/ns2:AvailBalRequest/ns2:Customer"/>
                </com:CustomerID>
              </xsl:if>
            </com:CustomerIdentifier>
          </custeo:Customer>
