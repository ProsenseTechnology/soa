  ...
  <xsl:template match="/">
    <rs:ServiceResponse>
      <rs:ResponseHeader>
        ...
        <rs:Operation>AvailBal</rs:Operation>
        <xsl:choose>
      ...
      <msg:AvailBalResponse>
        <msg:Balance>
          <xsl:value-of select="$Amount"/>
        </msg:Balance>
        <xsl:choose>
          <xsl:when test="/eo:ESBMsg/eo:RsData/eo:Account/com:Amount &lt; 0">
            <msg:Negative>Y</msg:Negative>
          </xsl:when>
          <xsl:otherwise>
            <msg:Negative>N</msg:Negative>
          </xsl:otherwise>
        </xsl:choose>
        <msg:Applies>Y</msg:Applies>
        <xsl:choose>
          <xsl:when test="/eo:ESBMsg/eo:RsData/eo:Account/eo:AccountStatus = A">
        ...
        <xsl:choose>
          <xsl:when test="/eo:ESBMsg/eo:RsData/eo:Account/com:AccountIdentifier/com:AccountID"></xsl:when>
          <xsl:otherwise>
            <msg:ErrorCode>2010</msg:ErrorCode>
          </xsl:otherwise>
        </xsl:choose>
        <msg:CheckedInBackOffice>N</msg:CheckedInBackOffice>
      </msg:AvailBalResponse>
    </rs:ServiceResponse>
  </xsl:template>
</xsl:stylesheet>